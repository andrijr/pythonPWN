...
from d5_2_database.p77 import user
from d5_2_database.p77.user import User, Moderator, Admin

users_role = ''
class DatabaseConnectionUser():
    def __init__(self):
        self.loginDatabaseUser("localhost", "python_user_table", "user_table", "python_p77")
